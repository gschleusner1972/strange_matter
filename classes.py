class component:
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, authur:str, sourcedata:str, sourcedata_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str):
		self.component_version = component_version; self.entity_guid = entity_guid; self.component_guid = component_guid; self.name = name; self.context = context; self.authur = authur; self.sourcedata = sourcedata; self.sourcedata_id = sourcedata_id; self.component_type = component_type; self.component_type_reference = component_type_reference; self.version = version; self.status = status; self.active = active; self.authur_software = authur_software; self.hash1 = hash1; self.payload_data_type = payload_data_type; self.date_created = date_created

class relationship(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, authur:str, sourcedata:str, sourcedata_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, source_entities:list, source_components:list, source_component_type:str, destination_entities:list, destination_components:list, destination_component_type:str, relationship_name:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, authur, sourcedata, sourcedata_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
