class component:
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str):
...
class relationship(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, source_entities:list, source_components:list, source_component_type:str, destination_entities:list, destination_components:list, destination_component_type:str, relationship_name:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
...
class location_transform(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, x, y, z):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
		self.x = x; self.y = y; self.z = z

class person_details(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, first:str, last:str, email:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
		self.first = first; self.last = last; self.email = email

class project_details(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, name:str, number:str, alias:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
		self.name = name; self.number = number; self.alias = alias

class project_group(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, name:str, group_type:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
...
class geometry(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, _geometry;str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
		self._geometry;str = _geometry;str

class classfication(component):
	def __init__(self, component_version:str, entity_guid:str, component_guid:str, name:str, context:str, author:str, source_data:str, source_data_id, component_type:str, component_type_reference:str, version:str, status:str, active:bool, authur_software:str, hash1:str, payload_data_type:str, date_created:str, name:str):
		super().__init__(component_version, entity_guid, component_guid, name, context, author, source_data, source_data_id, component_type, component_type_reference, version, status, active, authur_software, hash1, payload_data_type, date_created)
		self.name = name
